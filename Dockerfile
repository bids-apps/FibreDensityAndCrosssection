...
RUN wget -qO- http://github.com/MRtrix3/mrtrix3/archive/master.zip | bsdtar -xvf- && cd mrtrix3-master && python configure -nogui -verbose && python build && find . -type d -exec chmod 755 {} + && find scripts -maxdepth 1 -type f -exec chmod 775 {} +
